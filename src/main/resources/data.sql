...
INSERT INTO padel_customer (name, email, phone, user_id) VALUES
                                                             ('Niklas Einarsson','niklaseinasson@test.local','0700000001','niklaseinarsson'),
...
FROM padel_court c JOIN padel_customer cu ON cu.user_id='niklaseinarsson'
...
INSERT INTO padel_booking (court_id, customer_id, booking_date, start_time, end_time, number_of_players, price_sek, status)
SELECT c.id, cu.id, '2025-10-20','19:00:00','20:00:00',4,200,'ACTIVE'
FROM padel_court c JOIN padel_customer cu ON cu.user_id='niklaseinarsson'
WHERE c.court_number=2;

INSERT INTO padel_booking (court_id, customer_id, booking_date, start_time, end_time, number_of_players, price_sek, status)
SELECT c.id, cu.id, '2025-10-20','20:00:00','21:00:00',2,200,'ACTIVE'
FROM padel_court c JOIN padel_customer cu ON cu.user_id='benjaminportsmouth'
WHERE c.court_number=2;

INSERT INTO padel_booking (court_id, customer_id, booking_date, start_time, end_time, number_of_players, price_sek, status)
SELECT c.id, cu.id, '2025-10-21','18:00:00','19:00:00',2,200,'ACTIVE'
FROM padel_court c JOIN padel_customer cu ON cu.user_id='christofferfrisk'
WHERE c.court_number=2;

INSERT INTO padel_booking (court_id, customer_id, booking_date, start_time, end_time, number_of_players, price_sek, status)
SELECT c.id, cu.id, '2025-11-05','18:00:00','19:00:00',2,200,'ACTIVE'
FROM padel_court c JOIN padel_customer cu ON cu.user_id='niklaseinarsson'
WHERE c.court_number=2;

INSERT INTO padel_booking (court_id, customer_id, booking_date, start_time, end_time, number_of_players, price_sek, status)
SELECT c.id, cu.id, '2025-12-01','17:00:00','18:00:00',2,200,'CANCELED'
FROM padel_court c JOIN padel_customer cu ON cu.user_id='benjaminportsmouth'
WHERE c.court_number=1;